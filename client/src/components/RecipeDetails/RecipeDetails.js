        ...
        <div className="recipe-details">
            ...
            <div className="recipe-details__flex-container">
                ...
                <div className="recipe-details__recipe-description">
                    ...
                    <h3 className="recipe-details__total-price">$12.50</h3>
                    ...
                    <div className="recipe-details__btn-group">
                        <button className="recipe-details__btn recipe-details__btn--less">-</button>
                        <h1 className="recipe-details__serving-qty">2</h1>
                        <button className="recipe-details__btn recipe-details__btn--more">+</button>
                    </div>
